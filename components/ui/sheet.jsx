  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "fixed z-50 flex flex-col gap-4 bg-[#202831] text-[#eef2f5] transition ease-in-out data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:animate-in data-[state=open]:duration-500",
          side === "right" &&
        ...
        {showCloseButton && (
          <SheetPrimitive.Close
            className="absolute top-4 right-4 rounded-sm p-1 opacity-80 transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-[#44b388]/50 disabled:pointer-events-none">
...
function SheetTitle({
  ...
  return (
    <SheetPrimitive.Title
      ...
      className={cn("font-semibold text-[#f2f5f7]", className)}
      {...props} />
  );
}
...
function SheetDescription({
  ...
  return (
    <SheetPrimitive.Description
      ...
      className={cn("text-sm text-[#b2bbc4]", className)}
      {...props} />
  );
}
