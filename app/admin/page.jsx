      ...
      <div className="bg-[#172034] px-4 py-3 text-white">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="text-sm text-white/75">Build the shared Worship → Media → FOH service plan, assign who is serving, and configure volunteer readiness.</p>
          </div>
