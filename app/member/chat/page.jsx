  ...
  return (
    <main className="min-h-screen bg-[#f4f7f5]">
      <div className="border-b border-[#dbe7e0] bg-white px-4 py-3">
        <nav aria-label="Breadcrumb" className="mx-auto flex max-w-6xl flex-wrap items-center gap-2 text-sm text-[#5f7469]">
          ...
          <span aria-hidden="true">/</span>
          <span aria-current="page" className="font-semibold text-[#173329]">Chats</span>
        </nav>
      </div>
      <LibertyChat />
    </main>
