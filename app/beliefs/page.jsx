        ...
        <div className="mx-auto w-full max-w-6xl space-y-8 px-4 py-8 sm:px-6 sm:py-10 lg:px-8 lg:py-12">
          <BlurFade inView delay={0.04} className="space-y-2">
            ...
            <p className="max-w-3xl text-base leading-7 text-[#3F4D48]">
              Rooted in Scripture, centered on Jesus, and empowered by the Holy Spirit. Here is a clear, welcoming summary of what we believe.
            </p>
          </BlurFade>
            ...
            <section className="border border-[#E3E8E6] bg-white p-4 sm:p-6">
              <div className="space-y-2">
                ...
                <p className="text-base leading-7 text-[#3F4D48]">
                  We would love to talk with you more about what we believe and answer any questions you might have.
                </p>
              </div>
              <div className="mt-5 flex flex-wrap gap-3">
                ...
                <Button asChild variant="secondary" className="h-10 rounded-none border-[#1F4D3A] px-4 text-sm font-semibold">
