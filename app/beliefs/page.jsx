  ...
  return (
    <>
          ...
          <div className="beliefs-grid">
            ...
            <article className="belief-card">
              ...
              <details>
                <summary>Learn More</summary>
                <p>
                  We believe the Bible, in its original manuscripts, is without error and fully trustworthy. It is God&apos;s revelation to humanity, written by human authors
                  under the inspiration of the Holy Spirit. Scripture is our ultimate guide for what we believe and how we live.
                </p>
              </details>
            </article>
          </div>
          ...
          <div className="beliefs-grid">
            <article className="belief-card">
              ...
              <details>
                <summary>Learn More</summary>
                <p>
                  Jesus Christ is the second Person of the Trinity who became human while remaining fully divine. He lived a perfect, sinless life and voluntarily died on
                  the cross as the sacrifice for our sins. His resurrection from the dead proves His victory over sin and death, offering eternal life to all who believe.
                </p>
              </details>
            </article>
            ...
            <article className="belief-card">
              ...
              <details>
                <summary>Learn More</summary>
                <p>
                  Being "born again" means experiencing spiritual rebirth through the Holy Spirit. This isn&apos;t just turning over a new leaf—it&apos;s receiving new spiritual life
                  from God. The old life of sin is replaced with a new life in Christ, giving us both the desire and power to live for God.
                </p>
              </details>
            </article>
          </div>
          ...
          <div className="beliefs-grid">
            <article className="belief-card">
              ...
              <details>
                <summary>Learn More</summary>
                <p>
                  The Holy Spirit comes to live within every Christian at the moment of salvation. He guides us, teaches us truth, convicts us of sin, and empowers us to
                  live godly lives. The Spirit also gives spiritual gifts to believers for serving God and building up the church.
                </p>
              </details>
            </article>
            ...
            <article className="belief-card">
              <h3>The Church</h3>
              <p className="muted">The church is the body of Christ—all believers united together for worship, discipleship, and mission. (1 Corinthians 12:12-27; Matthew 28:19-20)</p>
              <details>
                <summary>Learn More</summary>
                <p>
                  The church isn&apos;t just a building—it&apos;s the community of all people who have trusted Jesus as their Savior. We gather together to worship God, learn from
                  His Word, encourage one another, and share the gospel with the world. Every believer is an important part of this body.
                </p>
              </details>
            </article>
            ...
            <article className="belief-card">
              ...
              <p className="muted">We practice believer&apos;s baptism by immersion and regular communion as acts of obedience and remembrance. (Matthew 28:19; 1 Corinthians 11:23-26)</p>
              <details>
                <summary>Learn More</summary>
                <p>
          ...
          <div className="beliefs-grid">
            <article className="belief-card">
              ...
              <details>
                <summary>Learn More</summary>
                <p>
                  We believe Jesus Christ will return to earth in the same bodily form in which He ascended to heaven. His return will be visible to all and will mark the
                  final judgment of humanity. This blessed hope motivates us to live faithfully and share the gospel urgently.
                </p>
              </details>
            </article>
      ...
      <section className="section alt">
        <div className="container">
          <h2>Questions About Our Beliefs?</h2>
